// v4_deploy.ino — Mini Sumo Arduino Nano, runs dqn3d_stack_stageA_best.pt
// (the 21-D "Stage-A" model: frame-stacked obs + flank reward + demo
// retention, trained on the realistic 3D PyBullet sim).
//
...
void setup() {
    ...
    Serial.println(F("ready (v4, 21-D stacked Stage-A)"));
}
